...
HD_PWD='C:/LSE/cese_clp/tp_softcore/synth/tp_softcore/tp_softcore.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_ila.tcl
