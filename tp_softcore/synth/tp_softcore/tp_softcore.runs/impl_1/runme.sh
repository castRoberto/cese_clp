...
HD_PWD='C:/LSE/cese_clp/tp_softcore/synth/tp_softcore/tp_softcore.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_ila.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vio_ila.tcl -notrace
