...
HD_PWD='C:/LSE/cese_clp/tp_softcore/ip_synth/tp_softcore_ip/tp_softcore_ip.runs/system_ip_fir_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ip_fir_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ip_fir_0_0.tcl
